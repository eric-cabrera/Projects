namespace Assurity.Kafka.Mappers.Tests
{
    ...
    public class PPBENPolicyBenefitsTypesSPMappingProfileTests
    {
        private IMapper Mapper
        {
            get
            {
                var mapper = new MapperConfiguration(configuration =>
                    configuration.AddProfile(typeof(PPBENPolicyBenefitsTypesSPMappingProfile)));
        ...
        [TestMethod]
        public void PPBENPolicyBenefitsTypesSPMappingProfile_AssertConfigurationIsValid()
        {
            // Assert
        ...
        [TestMethod]
        public void GenericRecord_To_PPBENPolicyBenefitsTypesSP_ShouldMap()
        {
            // Arrange
            ...
            // Act
            var ppben = Mapper.Map<PPBEN_POLICY_BENEFITS_TYPES_SP>(genericRecord);
