namespace Assurity.Kafka.Mappers.Tests
{
    ...
    public class PPBENPolicyBenefitsTypesSLMappingProfileTests
    {
        private IMapper Mapper
        {
            get
            {
                var mapper = new MapperConfiguration(configuration =>
                    configuration.AddProfile(typeof(PPBENPolicyBenefitsTypesSLMappingProfile)));
        ...
        [TestMethod]
        public void PPBENPolicyBenefitsTypesSLMappingProfile_AssertConfigurationIsValid()
        {
            // Assert
        ...
        [TestMethod]
        public void GenericRecord_To_PPBENPolicyBenefitsTypesSL_ShouldMap()
        {
            // Arrange
            ...
            // Act
            var ppben = Mapper.Map<PPBEN_POLICY_BENEFITS_TYPES_SL>(genericRecord);
