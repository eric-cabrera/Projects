namespace Assurity.Kafka.Engines.Tests
{
    ...
    public class MigrationHierarchyEngineTests
    {
        [TestMethod]
        public async Task GetPolicyHierarchy_BuildSuccessfulHierarchy()
        {
            ...
            mockDataStoreAccessor.Setup(accessor => accessor.GetAgentUpline(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<DateTime>()))
                .ReturnsAsync(() => null);
            mockDataStoreAccessor.Setup(accessor => accessor.GetAgentUpline("4321", "IS", "13", It.IsAny<DateTime>()))
                .ReturnsAsync(firstUpLine);
            mockDataStoreAccessor.Setup(accessor => accessor.GetAgentUpline("abc123", "IS", "50", It.IsAny<DateTime>()))
            ...
            var hierarchyEngine = new MigrateHierarchyEngine(mockDataStoreAccessor.Object, mockGlobalAccessor.Object, null);
        ...
        [TestMethod]
        public async Task GetPolicyHierarchy_BuildSuccessfulHierarchy_JITAgents()
        {
            // Arrange
            var policy = new Policy
            {
            ...
            mockDataStoreAccessor.Setup(accessor => accessor.GetAgentUpline(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<DateTime>()))
                .ReturnsAsync(() => null);
            mockDataStoreAccessor.Setup(accessor => accessor.GetAgentUpline("abc123", "IS", "55", It.IsAny<DateTime>()))
                .ReturnsAsync(secondUpLine);
            ...
            var hierarchyEngine = new MigrateHierarchyEngine(mockDataStoreAccessor.Object, mockGlobalAccessor.Object, mockSupportAccessor.Object);
        ...
        public void GetDistinctAgentIds_ReturnsDistinctAgents()
        {
            ...
            var hierarchyEngine = new MigrateHierarchyEngine(null, null, null);
        ...
        public async Task BuildAgentHierarchy_BuildSuccessfulHierarchy_WritingAgent_With_AdditionalAgentUplines()
        {
            ...
            mockDataStoreAccessor.Setup(accessor => accessor.GetAgentUpline(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<DateTime>()))
                .ReturnsAsync(() => null);
            mockDataStoreAccessor.Setup(accessor => accessor.GetAgentUpline("1234", "IS", "12", It.IsAny<DateTime>()))
                .ReturnsAsync(firstUpLine1);
            mockDataStoreAccessor.Setup(accessor => accessor.GetAgentUpline("abc123", "IS", "50", It.IsAny<DateTime>()))
                .ReturnsAsync(secondUpLine1);
            mockDataStoreAccessor.Setup(accessor => accessor.GetAgentUpline("4321", "IS", "13", It.IsAny<DateTime>()))
                .ReturnsAsync(firstUpLine2);
            mockDataStoreAccessor.Setup(accessor => accessor.GetAgentUpline("ghi123", "IS", "50", It.IsAny<DateTime>()))
        ...
        public async Task BuildAgentHierarchy_BuildSuccessfulHierarchy_WritingAgent_Without_HierarchyAgentsAndAdditionalAgentUplines()
        {
            ...
            var hierarchyEngine = new MigrateHierarchyEngine(mockDataStoreAccessor.Object, null, null);
            var isMigrationWorker = true;
